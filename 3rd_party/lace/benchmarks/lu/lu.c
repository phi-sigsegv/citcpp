 ...
 */
static void schur(Matrix M, Matrix V, Matrix W, int nb)
{
 ...
 */
static void lower_solve(Matrix M, Matrix L, int nb);
 ...
 */
static void upper_solve(Matrix M, Matrix U, int nb);
...
int main( int argc, char **argv )
{
    ...
    printf("Running lu n=%d sequentially...\n", n);
