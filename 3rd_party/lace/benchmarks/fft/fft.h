...
static void fft_twiddle_2(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
    int l1, i;
    COMPLEX *jp, *kp;
...
static void fft_twiddle_4(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
    int l1, i;
    COMPLEX *jp, *kp;
    REAL tmpr, tmpi, wr, wi;
...
static void fft_twiddle_8(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
    int l1, i;
    COMPLEX *jp, *kp;
    REAL tmpr, tmpi, wr, wi;
...
static void fft_twiddle_16(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
    int l1, i;
    COMPLEX *jp, *kp;
    REAL tmpr, tmpi, wr, wi;
...
static void fft_twiddle_32(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
    int l1, i;
    COMPLEX *jp, *kp;
    REAL tmpr, tmpi, wr, wi;
